...
| `layers`       | Contains information about your CARTO layers that have been added to the map in the `carto.layer.Layer` object. See this [CARTO.js documentation](https://carto.com/developers/carto-js/reference/#cartolayerlayer) for more information. The layer object will inherit the name given in the index.js file. This will contain most of the information about modifying the layer, query, dataviews, and styles. For example in the example application: `this.props.layers.railaccidents.source` will be used to modify the entire layer, `this.props.layers.railaccidents.style` contains styling information |
