...
class SegmentsWidget extends React.Component {
  state = {
    array: [],
    max: 0
  }
...
updateArray(id) {
  ...
  from (
    SELECT count(*) as value, x10 as name FROM mforrest.segement_tracts where exists
...
export default connect(mapStateToProps)(SegmentsWidget);
